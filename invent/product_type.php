...
<?php
	...
	$get_rows	= get_rows();
	$paginator->Per_Page('tbl_product_type', $where, $get_rows);
	$paginator->display($get_rows, 'index.php?content=type');

	$qs = dbQuery("SELECT * FROM tbl_product_type ".$where." LIMIT ".$paginator->Page_Start.", ".$paginator->Per_Page);
?>
	<div class="row">
    	<div class="col-sm-12">
		...
		<div class="modal-dialog" style="width:500px;">
			<div class="modal-content">
	  			<div class="modal-header">
					...
					<h4 class="modal-title" id="modal_title">เพิ่มชนิดสินค้า</h4>
				 </div>
				 <div class="modal-body" id="modal_body">
                 <div class="row">
                 	<div class="col-sm-6">
                    	<label>รหัส</label>
                        <input type="text" class="form-control input-sm" id="addCode" placeholder="กำหนดรหัสชนิดสินค้า" />
                        <span class="help-block red" id="addCode-error"></span>
                    </div>
                    <div class="divider-hidden"></div>
                    <div class="col-sm-12">
                    	<label>ชื่อชนิดสินค้า</label>
                        <input type="text" class="form-control input-sm" id="addName" placeholder="กำหนดชื่อชนิดสินค้า" />
		...
		<div class="modal-dialog" style="width:500px;">
			<div class="modal-content">
                 ...
                 <div class="row">
                 	<div class="col-sm-6">
                    	<label>รหัส</label>
                        <input type="text" class="form-control input-sm" id="editCode" placeholder="กำหนดรหัสชนิดสินค้า" />
                        <span class="help-block red" id="editCode-error"></span>
                    </div>
                    <div class="divider-hidden"></div>
                    <div class="col-sm-12">
                    	<label>ชื่อชนิดสินค้า</label>
                        <input type="text" class="form-control input-sm" id="editName" placeholder="กำหนดชื่อชนิดสินค้า" />
