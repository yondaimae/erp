...
<?php
	include 'include/sub_group_list.php';
?>
		...
		<div class="modal-dialog" style="width:500px;">
			<div class="modal-content">
	  			<div class="modal-header">
					...
					<h4 class="modal-title" id="modal_title">เพิ่มกล่มย่อยสินค้า</h4>
				 </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-sm-12">
                    	<label>ชื่อกลุ่มย่อยสินค้า</label>
	...
	<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" style="width:500px;">
			<div class="modal-content">
	  			<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="modal_title">เพิ่มกลุ่มย่อยสินค้า</h4>
            <input type="hidden" id="id_sub_group" value="" />
				 </div>
				 <div class="modal-body" id="modal_body">
                 <div class="row">
                 	<div class="col-sm-6">
...
<script src="script/sub_group.js"></script>
