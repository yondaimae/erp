...
<table id="myTable" class="table table-striped table-bordered tablesorter">
  <thead>
    <tr>
      ...
      <th class="width-50 text-center">ผู้รับ</th>
      <th class="width-10 text-center">จำนวน</th>
      <th class="width-15 text-center">มูลค่า(VAT inc.)</th>
    </tr>
  </thead>

  {{#if nodata}}
    <tr>
      <td colspan="6" class="text-center">ไม่พบรายการตามเงื่อนไขที่กำหนด</td>
    </tr>
  {{else}}
    {{#each this}}
...
<script src="script/report/sale/sponsor_by_customer_order.js"></script>
