...
function getEdit(id){
	$.ajax({
		url:"controller/customerTypeController.php?getData",
...
function saveEdit(){
	...
	$.ajax({
		url:"controller/customerTypeController.php?saveEditType",
...
function addNew(){
	...
	$.ajax({
		url:"controller/customerTypeController.php?addType",
...
function remove(id, code){
	swal({
		...
		$.ajax({
			url:"controller/customerTypeController.php?deleteType",
			type:"GET", cache:"false", data: { "id" : id },
			success: function(rs){
				var rs = $.trim(rs);
				if( rs == 'success' ){
...
function goBack(){
	window.location.href = "index.php?content=customer_type";
}
...
function clearFilter(){
	$.get("controller/customerTypeController.php?clearFilter", function(){ goBack(); });
}
