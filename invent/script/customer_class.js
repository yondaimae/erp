...
function getEdit(id){
	$.ajax({
		url:"controller/customerClassController.php?getData",
...
function saveEdit(){
	...
	$.ajax({
		url:"controller/customerClassController.php?saveEditClass",
...
function addNew(){
	...
	$.ajax({
		url:"controller/customerClassController.php?addClass",
...
function remove(id, code){
	swal({
		...
		$.ajax({
			url:"controller/customerClassController.php?deleteClass",
			type:"GET", cache:"false", data: { "id" : id },
			success: function(rs){
				var rs = $.trim(rs);
				if( rs == 'success' ){
...
function goBack(){
	window.location.href = "index.php?content=customer_class";
}
...
function clearFilter(){
	$.get("controller/customerClassController.php?clearFilter", function(){ goBack(); });
}
