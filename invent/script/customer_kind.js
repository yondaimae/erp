...
function getEdit(id){
	$.ajax({
		url:"controller/customerKindController.php?getData",
...
function saveEdit(){
	...
	$.ajax({
		url:"controller/customerKindController.php?saveEditKind",
...
function addNew(){
	...
	$.ajax({
		url:"controller/customerKindController.php?addKind",
...
function remove(id, code){
	swal({
		...
		$.ajax({
			url:"controller/customerKindController.php?deleteKind",
			type:"GET", cache:"false", data: { "id" : id },
			success: function(rs){
				var rs = $.trim(rs);
				if( rs == 'success' ){
...
function goBack(){
	window.location.href = "index.php?content=customer_kind";
}
...
function clearFilter(){
	$.get("controller/customerKindController.php?clearFilter", function(){ goBack(); });
}
