     ...
     <table class="table table-striped table-bordered">
       <thead>
         <tr>
           ...
           <th class="width-10 text-center">จำนวนที่ตัด</th>
         </tr>
       </thead>
       <tbody>
...
<?php   $barcode = $bc->getBarcode($rs->id_product); ?>
      ...
      <?php if( $rs->valid == 0) : ?>
            ...
            <input type="hidden" name="detail[<?php echo $rs->id_product; ?>]" value="<?php echo $rs->id; ?>" />
            <?php
...
<?php   endwhile; ?>
        <tr>
          ...
          <td class="middle text-center" id="totalReceived"><?php echo number($totalSent); ?></td>
        </tr>
<?php else: ?>
        <tr>
