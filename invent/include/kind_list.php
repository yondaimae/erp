...
<?php
	...
	$get_rows	= get_rows();
	$paginator->Per_Page('tbl_product_kind', $where, $get_rows);
	$paginator->display($get_rows, 'index.php?content=kind');

	$qs = dbQuery("SELECT * FROM tbl_product_kind ".$where." LIMIT ".$paginator->Page_Start.", ".$paginator->Per_Page);
?>
	<div class="row">
    	<div class="col-sm-12">
