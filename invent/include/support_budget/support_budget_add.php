...
<div class="row top-row">
  ...
  <div class="col-sm-6 col-xs-12">
    <p class="pull-right top-p">
      ...
      <?php if( $add ) : ?>
      <button type="button" class="btn btn-sm btn-success" onclick="saveSupport()"><i class="fa fa-save"></i> บันทึก</button>
      <?php endif; ?>
    </p>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-sm-4 col-sm-offset-4 margin-top-10">
    <label>เลขที่เอกสาร/เลขที่อ้างอิง</label>
...
<script src="script/support_budget/support_budget_add.js"></script>
