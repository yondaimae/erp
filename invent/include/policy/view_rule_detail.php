  ...
  <div class="col-sm-12">
    <table class="table table-striped table-bordered">
      <tr class="">
        ...
        <td class="width-20 middle"><?php echo $cs->code; ?></td>
        <td class="width-15 middle text-right"><strong>ชื่อกฏ</strong></td>
        <td class="width-50 middle" ><?php echo $cs->name; ?></td>
      </tr>
      <tr>
        <td class="middle text-right"><strong>รหัสนโยบาย</strong></td>
        <td class="middle"><?php echo $pl->reference; ?></td>
        <td class="middle text-right"><strong>ชื่อนโยบาย</strong></td>
        <td class="middle" ><?php echo $pl->name; ?></td>
      </tr>
      <tr class="">
        <td class="middle text-right"><strong>วันที่เพิ่ม</strong></td>
        <td class="middle"><?php echo thaiDate($cs->date_add); ?></td>
        <td class="middle text-right"><strong>พนักงาน</strong></td>
        <td class="middle" ><?php echo $emp->getFullName($cs->id_emp); ?></td>
      </tr>
      <tr>
        <td class="middle text-right"><strong>วันที่ปรับปรุง</strong></td>
        <td class="middle"><?php echo thaiDate($cs->date_upd); ?></td>
        <td class="middle text-right"><strong>พนักงาน</strong></td>
        <td class="middle" ><?php echo $emp->getFullName($cs->emp_upd); ?></td>
      </tr>
      <tr class="">
        ...
        <td class="middle"><?php echo ($cs->item_price > 0 ? number($cs->item_price, 2).' '.$currency : 'No'); ?></td>
      </tr>
      <tr>
        <td class="middle text-right"><strong>จำนวนขั้นต่ำ</strong></td>
        <td class="middle"><?php echo ($cs->qty > 0 ? number($cs->qty) : 'No'); ?></td>
        <td class="middle text-right"><strong>มูลค่าขั้นต่ำ</strong></td>
        <td class="middle"><?php echo ($cs->amount > 0 ? number($cs->amount, 2).' '.$currency : 'No'); ?></td>
      </tr>
      <tr>
        <td class="middle text-right"><strong>รวมยอดได้</strong></td>
        <td class="middle"><?php echo $cs->canGroup == 1 ? 'Yes' : 'No'; ?></td>
      </tr>
