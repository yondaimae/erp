...
//---  Report title
$report_title = 'รายงานการรับสินค้าแยกตามเอกสาร  วันที่ '.$date_range.'      (  วันที่พิมพ์รายงาน : '.date('d/m/Y').'  เวลา : '.date('H:i:s').' )';;
...
$excel->getActiveSheet()->setTitle('Receive By Document');
...
setToken($_GET['token']);
$file_name = "Received_by_document.xlsx";
