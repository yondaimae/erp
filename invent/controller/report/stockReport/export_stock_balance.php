...
//---  Report title
$report_title = 'รายงานสินค้าคงเหลือ ณ วันที่  '.thaiDateTime(date('Y-m-d H:i:s'), '/').'      (  วันที่พิมพ์รายงาน : '.date('d/m/Y').'  เวลา : '.date('H:i:s').' )';;
...
$qr  = "SELECT b.barcode, p.code, p.name, p.year, p.cost, SUM(s.qty) AS qty ";
