...
if( isset( $_GET['add'] ) )
{
	include 'include/order_consign/consign_add.php';
}
else if( isset( $_GET['edit'] ) )
{
	include 'include/order_consign/consign_edit.php';
}
...
{
	include 'include/order_consign/consign_list.php';
}

?>

</div><!--/container-->
<script src="script/order_consign/consign.js"></script>
