...
function getEdit(id){
	$.ajax({
		url:"../invent/controller/productTabController.php?getData",
...
function goAdd(){
	$.ajax({
		url:"../invent/controller/productTabController.php?getTabsTree"	,
...
function saveEdit(){
	...
	$.ajax({
		url:"../invent/controller/productTabController.php?saveEditTab",
...
function remove(id, code){
	swal({
		...
		$.ajax({
			url:"../invent/controller/productTabController.php?deleteTab",
			type:"GET", cache:"false", data: { "id" : id },
			success: function(rs){
				var rs = $.trim(rs);
				if( rs == 'success' ){
...
function clearFilter(){
	$.get("../invent/controller/productTabController.php?clearFilter", function(){ goBack(); });
}
